...
<div class="box">
  <div class="box-header with-border">
    ...
    <div style="float: right;">
      <form id="ticket-completed-form2">
        <select id="site" name="site" onchange="LoadTicketCompletedChart2();">
        ...
        <select id="company" name="company" onchange="LoadTicketCompletedChart2();">
        ...
        <select id="ticket-type" name="ticket-type" onchange="LoadTicketCompletedChart2();">
    ...
    <div id="ticket-completed-loader2" class="loader">
  ...
  <div class="box-body">
    <div class="chart">
      <canvas id="ticket-completed-chart2" style="height: 230px; width: 433px;" height="230" width="433"></canvas>
    </div>
  </div>
</div>
<?= includePageScript('widgets', 'ticket-completed-chart2.js'); ?>