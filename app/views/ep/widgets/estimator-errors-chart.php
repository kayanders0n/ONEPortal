<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Estimator Errors</h3>
    <div class="box-tools pull-right">
      <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
    </div>
    <div style="clear:both;"></div>
    <div style="float: right;">
      <form id="estimator-errors-form">
        <select id="company" name="company" onchange="LoadEstimatorErrorsChart();">
        ...
        <select id="days-old" name="days_old" onchange="LoadEstimatorErrorsChart();">
    ...
    <div id="estimator-errors-loader" class="loader">
  ...
  <div class="box-body">
    <div class="chart">
      <canvas id="estimator-errors-chart" style="height: 230px; width: 433px;" height="230" width="433"></canvas>
    </div>
  </div>
</div>
<?= includePageScript('widgets', 'estimator-errors-chart.js'); ?>
