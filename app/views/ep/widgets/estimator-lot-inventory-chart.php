<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Estimator Lot Inventory</h3>
    <div class="box-tools pull-right">
      <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
    </div>
    <div style="clear:both;"></div>
    <div style="float: right;">
      <form id="estimator-lot-inventory-form">
        <select id="company" name="company" onchange="LoadEstimatorLotInventoryChart();">
          ...
          <select id="project-site" name="project_site" onchange="LoadEstimatorLotInventoryChart();">
    ...
    <div id="estimator-lot-inventory-loader" class="loader">
  ...
  <div class="box-body">
    <div class="chart">
      <canvas id="estimator-lot-inventory-chart" style="height: 230px; width: 433px;" height="230" width="433"></canvas>
    </div>
  </div>
</div>
<?= includePageScript('widgets', 'estimator-lot-inventory-chart.js'); ?>
