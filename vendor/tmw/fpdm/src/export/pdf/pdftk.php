 ...
 *@version 2.0man
 *@note
 *	V2.0man '06.29.2021) altered for better php 7 support open_proc.
...
define("PHP7_ENGINE",version_compare(phpversion(), "7"));
...
function pdftk($pdf_file,$fdf_file,$settings) {
    ...
    if(file_exists("$dircmd/$cmd")) {
        ...
        if(PHP7_ENGINE) {
            $process = proc_open($cmdline, $descriptorspec, $pipes, null, null);
        } else if(PHP5_ENGINE) { // Php5
